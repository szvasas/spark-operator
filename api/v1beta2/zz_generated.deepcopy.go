...
func (in *DriverSpec) DeepCopyInto(out *DriverSpec) {
	*out = *in
	...
	if in.MonitoredSidecars != nil {
		in, out := &in.MonitoredSidecars, &out.MonitoredSidecars
		*out = new(string)
		**out = **in
	}
	if in.FailOnMonitoredSidecarZeroExitCode != nil {
		in, out := &in.FailOnMonitoredSidecarZeroExitCode, &out.FailOnMonitoredSidecarZeroExitCode
		*out = new(bool)
		**out = **in
	}
}
